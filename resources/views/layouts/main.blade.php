    ...
    <div class="container">
        <div class="footer-banner" data-aos="fade-up">
            ...
            <div class="banner-btns-wrapper">
                <button class="btn btn-success"><img src=" as{{ asset('sets/images/apple@1x.svg') }}" alt="ios" class="mr-2"> App Store
                </button>
                <button class="btn btn-success"><img src=" as{{ asset('sets/images/android@1x.svg') }}" alt="android" class="mr-2">
                    Google Play
                </button>
            </div>
        ...
        <div class="row footer-widget-area">
            <div class="col-md-3">
                <a href="index.html" class="footer-brand-wrapper">
                    <img src=" as{{ asset('') }}sets/images/logo.svg" alt="edica logo">
                </a>
